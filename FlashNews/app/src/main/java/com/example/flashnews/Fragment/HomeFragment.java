...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        // Inisialisasi layout no internet


        // Sembunyikan layout no internet secara default
        layoutNoInternet.setVisibility(View.GONE);

        // Periksa koneksi internet saat fragment dimuat
        ...
        btnRetry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Coba kembali ketika tombol retry ditekan
                checkInternetConnection();
            }
        });

        // Tampilkan ProgressBar saat pertama kali fragment dimuat
        progressBar.setVisibility(View.VISIBLE);

//        tam
//        getNewsFromApi("bitcoin");
//        tamb
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                getNewsFromApi("bitcoin");
                progressBar.setVisibility(View.GONE); // Sembunyikan ProgressBar setelah mendapatkan respon
            }
    ...
    private void getNewsFromApi(String query) {
        ...
        Call<NewsResponse> call = apiService.getEverything(query, "2af87976fc3a4e74981179e9c30ff663");
